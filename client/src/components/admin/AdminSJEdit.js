    ...
    return (
        <Container className='admin content__body'>
            <div className='admin__inner'>
                <h2 className="admin__title title">EDIT SURAQ - JAUAP</h2>
                            ...
                            <Form.Group controlId={`formQuestionText${qIndex}`}>
                                ...
                                <div className="d-flex align-items-center">
                                    <Form.Control
                                        ...
                                        className="mr-2"
                                    />
                                    <Button variant="danger" onClick={() => deleteQuestion(qIndex)} className="mt-2 admin__btn-delete">
                                        <FontAwesomeIcon icon={faTrashAlt} />
                                    </Button>
                                </div>
                            </Form.Group>
                            {question.options.map((option, oIndex) => (
                                <Row key={oIndex} className="mb-2 suraq-edit__answers d-flex justify-content-between align-items-center">
                                    <Col md={8}>
                                        <Form.Control
                                            type="text"
